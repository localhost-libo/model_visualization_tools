...
@license
dhtmlxScheduler v.5.3.2 Professional
...
var s=JSON.parse(i);a=s.options[0].text}catch(i){var _=e.$ajax.xpath("//option",t.xmlDoc)[0];a=_.childNodes[0].nodeValue}n.cached_options[o]=a,r.addOption(o,a),r.disable(1),r.selectOption(0),r.disable(0)}):r.setComboValue("")}else{for(var s=[],_=0;_<n.options.length;_++){var d=n.options[_],l=[d.key,d.label,d.css];s.push(l)}if(r.addOption(s),i[n.map_to]){var c=r.getIndexByValue(i[n.map_to]);r.selectOption(c)}}},get_value:function(e,t,a){var i=e._combo.getSelectedValue()
...
t=document.getElementById(n.id);var r=e.uid(),o=void 0!==n.checked_value?a==n.checked_value:!!a;t.className+=" dhx_cal_checkbox";var s="<input id='"+r+"' type='checkbox' value='true' name='"+n.name+"'"+(o?"checked='true'":"")+"'>",_="<label for='"+r+"'>"+(e.locale.labels["section_"+n.name]||n.name)+"</label>";if(e.config.wide_form?(t.innerHTML=_,t.nextSibling.innerHTML=s):t.innerHTML=s+_,n.handler){t.getElementsByTagName("input")[0].onclick=n.handler}},get_value:function(e,t,a){
