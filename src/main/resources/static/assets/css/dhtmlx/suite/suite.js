...
dhtmlxSuite v.6.3.1 Professional
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(33), __webpack_require__(90).setImmediate))
...
var drivers_1 = __webpack_require__(59);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ajax_1 = __webpack_require__(58);
...
Object.defineProperty(exports, "__esModule", { value: true });
var AxisCreator_1 = __webpack_require__(149);
var types_1 = __webpack_require__(7);
var SvgScales_1 = __webpack_require__(71);
var common_1 = __webpack_require__(6);
var renderScale = {
...
var common_1 = __webpack_require__(6);
var types_1 = __webpack_require__(7);
var BaseSeria_1 = __webpack_require__(46);
...
var types_1 = __webpack_require__(7);
var common_1 = __webpack_require__(6);
var line_1 = __webpack_require__(152);
...
var dom_1 = __webpack_require__(0);
var common_1 = __webpack_require__(6);
var ScaleSeria_1 = __webpack_require__(45);
...
Object.defineProperty(exports, "__esModule", { value: true });
var events_1 = __webpack_require__(2);
var loader_1 = __webpack_require__(94);
var sort_1 = __webpack_require__(97);
var dataproxy_1 = __webpack_require__(25);
...
Object.defineProperty(exports, "__esModule", { value: true });
var JsonDriver_1 = __webpack_require__(60);
var CsvDriver_1 = __webpack_require__(61);
var XMLDriver_1 = __webpack_require__(95);
exports.dataDrivers = {
...
var Bar = /** @class */ (function (_super) {
    ...
    Bar.prototype._getForm = function (points, css, _width, height, prev) {
        var _this = this;
        var _a = this.config, fill = _a.fill, alpha = _a.alpha, showText = _a.showText, showTextTemplate = _a.showTextTemplate;
        var svg = [];
        ...
        if (showText || showTextTemplate) {
            ...
            var text = points.map(function (item, index) {
                ...
                return isWrite_1(item, index) ? dom_1.sv("text", _this._text(item, getPrev(index)), [showTextTemplate ? common_1.verticalCenteredText(showTextTemplate(value)) : common_1.verticalCenteredText(value)]) : null;
            });
...
var editors_1 = __webpack_require__(191);
function handleMouse(rowStart, colStart, conf, type, e) {
    // FIXME - move to helpers
    var target = e.target;
    while (target) {
        if (target.classList && target.classList.contains("dhx_grid-cell")) {
            break;
        }
        target = target.parentNode;
    }
        ...
        return dom_1.el(".dhx_grid-row", {
            ...
            if (!col.hidden) {
                ...
                if (typeof content === "string") {
                    // QUESTION - do we really need the dhx_cell-content - it doesn't set for number cells anyway
                    content = dom_1.el("div.dhx_cell-content", 
                    // if user set template or enabled HTML - render as html otherwise as a plain text
                    col.template || (conf.htmlEnable && col.htmlEnable !== false) || col.htmlEnable ?
                        { ".innerHTML": content } :
                        content);
                }
                ...
                var isEditable = conf.$editable && conf.$editable.row === row.id && conf.$editable.col === col.id;
                if (isEditable || (col.type === "boolean" && (conf.editing || col.editing))) {
...
var main_1 = __webpack_require__(20);
var types_1 = __webpack_require__(10);
var content_1 = __webpack_require__(79);
...
function getRows(config, rowsConfig) {
    ...
    return rows.map(function (row, j) { return dom_1.el(".dhx_" + rowName + "-row", { style: { height: rowHeight } }, row.map(function (cell, i) {
        ...
        return !column.hidden ? dom_1.el(".dhx_grid-" + rowName + "-cell", __assign({ class: css.trim(), dhx_id: column.id, _key: i, style: {
                width: column.width,
...
var ts_treegrid_1 = __webpack_require__(215);
...
/* tslint:disable */
var CssManager_1 = __webpack_require__(88);
...
var ts_list_1 = __webpack_require__(37);
exports.List = ts_list_1.List;
var ts_calendar_1 = __webpack_require__(29);
...
var ts_chart_1 = __webpack_require__(141);
...
var ts_dataview_1 = __webpack_require__(167);
exports.DataView = ts_dataview_1.DataView;
var ts_form_1 = __webpack_require__(171);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(33), __webpack_require__(92)))
...
Object.defineProperty(exports, "__esModule", { value: true });
var xml_1 = __webpack_require__(96);
...
Object.defineProperty(exports, "__esModule", { value: true });
var html_1 = __webpack_require__(3);
var CollectionStore_1 = __webpack_require__(100);
var types_1 = __webpack_require__(15);
var helpers_1 = __webpack_require__(16);
...
var events_1 = __webpack_require__(2);
var html_1 = __webpack_require__(3);
var scrollView_1 = __webpack_require__(103);
var view_1 = __webpack_require__(4);
var ts_data_1 = __webpack_require__(5);
var ts_layout_1 = __webpack_require__(14);
var ts_message_1 = __webpack_require__(19);
...
var configs_1 = __webpack_require__(122);
var helper_1 = __webpack_require__(123);
var ProgressBar_1 = __webpack_require__(124);
var ReadStackPreview_1 = __webpack_require__(125);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Cell_1 = __webpack_require__(105);
...
var view_1 = __webpack_require__(4);
var types_1 = __webpack_require__(27);
var helpers_1 = __webpack_require__(106);
var events_1 = __webpack_require__(2);
...
Object.defineProperty(exports, "__esModule", { value: true });
var button_1 = __webpack_require__(113);
var navItem_1 = __webpack_require__(114);
var customHTMLButton_1 = __webpack_require__(115);
var imageButton_1 = __webpack_require__(116);
var input_1 = __webpack_require__(117);
var menuItem_1 = __webpack_require__(118);
var separator_1 = __webpack_require__(119);
var spacer_1 = __webpack_require__(120);
var title_1 = __webpack_require__(121);
var types_1 = __webpack_require__(22);
...
var helpers_1 = __webpack_require__(129);
                ...
                didMount: function (vm) {
                    if (!_this.config.height) {
                        ...
                        _this.config.height = (element && element.parentNode &&
                            element.parentNode.offsetHeight) || 200;
                    }
                    if (_this.config.virtual) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var InputEditor_1 = __webpack_require__(128);
...
var view_1 = __webpack_require__(4);
var ts_timepicker_1 = __webpack_require__(30);
var DateHelper_1 = __webpack_require__(135);
var DateFormatter_1 = __webpack_require__(40);
var helper_1 = __webpack_require__(136);
var en_1 = __webpack_require__(41);
...
var colors_1 = __webpack_require__(138);
var en_1 = __webpack_require__(43);
...
// tslint:disable-next-line
var ts_message_1 = __webpack_require__(19);
var picker_1 = __webpack_require__(139);
var calculations_1 = __webpack_require__(140);
...
var view_1 = __webpack_require__(4);
var ts_data_1 = __webpack_require__(5);
var ComposeLayer_1 = __webpack_require__(143);
var Legend_1 = __webpack_require__(145);
var index_1 = __webpack_require__(147);
var index_2 = __webpack_require__(151);
var Stacker_1 = __webpack_require__(161);
var Tooltip_1 = __webpack_require__(162);
var types_1 = __webpack_require__(7);
...
Object.defineProperty(exports, "__esModule", { value: true });
var dom_1 = __webpack_require__(0);
var Filters_1 = __webpack_require__(144);
var ComposeLayer = /** @class */ (function () {
    ...
    ComposeLayer.prototype.toVDOM = function (width, height) {
        ...
        var chartsContent = dom_1.sv("g", {
            ...
            dom_1.sv("rect.dhx_chart-graph_area", { width: width - sizes.left - sizes.right, height: height - sizes.top - sizes.bottom, fill: "transparent" }),
...
var dom_1 = __webpack_require__(0);
var common_1 = __webpack_require__(6);
var legend_1 = __webpack_require__(146);
...
Object.defineProperty(exports, "__esModule", { value: true });
var RadialScale_1 = __webpack_require__(148);
var Scale_1 = __webpack_require__(44);
var TextScale_1 = __webpack_require__(150);
var scaleTypes = {
...
Object.defineProperty(exports, "__esModule", { value: true });
var Area_1 = __webpack_require__(72);
var Bar_1 = __webpack_require__(73);
var BarX_1 = __webpack_require__(153);
var Donut_1 = __webpack_require__(154);
var Line_1 = __webpack_require__(48);
var Pie_1 = __webpack_require__(155);
var Pie3D_1 = __webpack_require__(156);
var Radar_1 = __webpack_require__(157);
var Scatter_1 = __webpack_require__(158);
var Spline_1 = __webpack_require__(159);
var SplineArea_1 = __webpack_require__(160);
var seriesTypes = {
...
var common_1 = __webpack_require__(6);
var types_1 = __webpack_require__(7);
var NoScaleSeria_1 = __webpack_require__(47);
...
var events_1 = __webpack_require__(2);
var html_1 = __webpack_require__(3);
var keycodes_1 = __webpack_require__(164);
var view_1 = __webpack_require__(4);
var ts_data_1 = __webpack_require__(5);
var ts_layout_1 = __webpack_require__(14);
var ts_list_1 = __webpack_require__(37);
var ts_popup_1 = __webpack_require__(11);
var keyListener_1 = __webpack_require__(165);
var en_1 = __webpack_require__(49);
var helper_1 = __webpack_require__(166);
...
var Combobox = /** @class */ (function (_super) {
    ...
    function Combobox(element, config) {
        ...
        _this.popup.events.on(ts_popup_1.PopupEvents.beforeHide, function (fromOuterClick) {
            if (fromOuterClick) {
                _this.events.fire(types_1.ComboboxEvents.close);
            }
        });
...
var editors_1 = __webpack_require__(169);
...
Object.defineProperty(exports, "__esModule", { value: true });
var InputEditor_1 = __webpack_require__(170);
...
var button_1 = __webpack_require__(174);
var checkbox_1 = __webpack_require__(175);
var input_1 = __webpack_require__(51);
var radioGroup_1 = __webpack_require__(176);
var select_1 = __webpack_require__(178);
var textarea_1 = __webpack_require__(179);
var textinput_1 = __webpack_require__(180);
var combo_1 = __webpack_require__(181);
var sliderform_1 = __webpack_require__(182);
var helper_1 = __webpack_require__(9);
var simplevault_1 = __webpack_require__(183);
var timeInput_1 = __webpack_require__(184);
var colorpicker_1 = __webpack_require__(185);
var types_1 = __webpack_require__(8);
    ...
    Form.prototype._addLayoutItem = function (item) {
        ...
        switch (config.type) {
            ...
            case types_1.FormItemType.timepicker:
                ...
                if (timeInput_2.config.actions) {
                    timeInput_2.timepicker.events.on(ts_timepicker_1.TimepickerEvents.save, function () {
...
var Checkbox = /** @class */ (function (_super) {
    ...
    function Checkbox(container, config) {
        ...
        _this.events = new events_1.EventSystem();
        _this.events.on(types_1.BaseElementEvent.change, function (value) {
...
var events_1 = __webpack_require__(2);
var view_1 = __webpack_require__(4);
var radiobutton_1 = __webpack_require__(177);
var helper_1 = __webpack_require__(9);
var types_1 = __webpack_require__(8);
...
var ts_popup_1 = __webpack_require__(11);
var helper_1 = __webpack_require__(9);
var en_1 = __webpack_require__(76);
var types_1 = __webpack_require__(8);
var SimpleVault = /** @class */ (function (_super) {
    ...
    function SimpleVault(container, config) {
        ...
        _this.events.on(types_1.BaseElementEvent.change, function () {
            _this.validate();
            _this.paint();
        });
        _this._handlers = {
...
var TimeInput = /** @class */ (function (_super) {
    ...
    TimeInput.prototype.setValue = function (value) {
        ...
        if (this.config.actions) {
            this.timepicker.events.fire(ts_timepicker_1.TimepickerEvents.save, []);
        }
        this.paint();
    };
    TimeInput.prototype.setConfig = function (config) {
        ...
        if (this.config.actions) {
            ...
            this.timepicker.events.on(ts_timepicker_1.TimepickerEvents.save, function () {
    ...
    TimeInput.prototype._getHandlers = function () {
        ...
        return {
            ...
            onkeyup: function (e) {
                var value = e.target.value.trim();
                if (!_this.config.actions && e.keyCode === 13) {
                    if (_this._popup.isVisible()) {
                        _this._popup.hide();
                    }
                    var node = _this.getRootView().refs.input.el;
...
var view_1 = __webpack_require__(4);
var ts_data_1 = __webpack_require__(5);
var Exporter_1 = __webpack_require__(187);
var data_1 = __webpack_require__(53);
var main_1 = __webpack_require__(20);
var Selection_1 = __webpack_require__(188);
var Hotkey_1 = __webpack_require__(189);
var types_1 = __webpack_require__(10);
var render_1 = __webpack_require__(190);
var core_1 = __webpack_require__(1);
var content_1 = __webpack_require__(79);
var columnsResizer_1 = __webpack_require__(198);
var Grid = /** @class */ (function (_super) {
        ...
        var htmlEvents = {
            onclick: html_1.eventHandler(function (ev) { return html_1.locate(ev); }, {
                "dhx_grid-header-cell": function (_ev, item) {
                    var resizedColumn = _ev.target.getAttribute("dhx_resized");
                    if (_this.config.headerSort && !resizedColumn) {
    ...
    Grid.prototype._setEventHandlers = function () {
        ...
        this.events.on(types_1.GridEvents.afterEditEnd, function (value, eRow, eCol) {
            ...
            delete item.$empty;
            if (value !== undefined) {
                _this.data.update(row, __assign({}, item, (_a = {}, _a[col] = value, _a)));
            }
    ...
    Grid.prototype._setAutoWidth = function (colsCount) {
        ...
        this.config.$totalWidth = this.config.columns.reduce(function (t, col) {
            ...
            return t += col.hidden ? 0 : col.width;
        }, 0);
    };
...
var Selection = /** @class */ (function () {
    ...
    Selection.prototype.toHTML = function () {
        if (!this._selectedCell || !this._selectedCell.row || !this._selectedCell.column) {
            return;
        }
        ...
        if (fixedColsIds.indexOf(this._selectedCell.column.id) !== -1) {
            ...
            fixedCell = dom_1.el(".dhx_grid-selected-cell", {
                style: {
                    width: (this._grid.config.splitAt === fixedColsIds.indexOf(this._selectedCell.column.id) + 1) ? cellRect.width - 1 : cellRect.width,
...
function initHotkeys(grid) {
    ...
    gridContainer.addEventListener("mousedown", function (e) {
        var target = e.target;
        if (isChild(gridContainer, target) || target.isEqualNode(gridContainer)) {
            focusHandler.setFocusState(gridId);
        }
    });
    focusableKeyManager.addHotKey("enter", function () {
        if (cellSelecting(grid.config.selection)) {
            ...
            if (selected.column.editing !== false && grid.config.editing || selected.column.editing) {
    ...
    focusableKeyManager.addHotKey(variables.space, function (e) {
        if (cellSelecting(grid.config.selection) && grid.config.editing && !grid.config.$editable) {
            var selected = grid.selection.getCell();
            if (selected.column.type === "boolean") {
                e.preventDefault();
                grid.events.fire(types_1.GridEvents.afterEditEnd, [!selected.row[selected.column.id], selected.row, selected.column]);
    ...
    focusableKeyManager.addHotKey("ctrl+" + variables.arrowLeft, function () {
        selectionMove(null, grid, "horizontal", -1, true);
    });
    focusableKeyManager.addHotKey("ctrl+" + variables.arrowRight, function () {
        selectionMove(null, grid, "horizontal", 1, true);
    });
    focusableKeyManager.addHotKey("ctrl+" + variables.arrowUp, function () {
        selectionMove(null, grid, "vertical", -1, true);
    });
    focusableKeyManager.addHotKey("ctrl+" + variables.arrowDown, function () {
        selectionMove(null, grid, "vertical", 1, true);
    });
}
...
function selectionMove(e, grid, dir, range, toEnd) {
    ...
    if (selected) {
        if (dir === "vertical") {
            if (toEnd) {
                ...
                grid.selection.setCell(newItem.id, selected.column.id.toString());
            ...
            if (toEnd) {
                ...
                grid.selection.setCell(selected.row.id.toString(), newItem.id.toString());
                ...
                if (index + range >= 0 && index + range < grid.config.columns.length) {
                    grid.selection.setCell(selected.row.id.toString(), grid.config.columns[index + range].id.toString());
...
var data_1 = __webpack_require__(53);
var main_1 = __webpack_require__(20);
var Cells_1 = __webpack_require__(77);
var FixedCols_1 = __webpack_require__(197);
...
function render(vm, obj, data, htmlEvents, selection, uid) {
    ...
    if (config.fitToContainer) {
        ...
        var mTotal = config.columns.reduce(function (width, col) {
            var unchangeable = (col.maxWidth && (col.maxWidth < (col.width * per_1))) || (col.minWidth && (col.minWidth > (col.width * per_1)));
        ...
        config.columns.map(function (col) {
            var unchangeable = (col.maxWidth && (col.maxWidth < (col.width * newPer_1))) || (col.minWidth && (col.minWidth > (col.width * newPer_1)));
            if (!unchangeable) {
                col.width = col.width * newPer_1;
            }
            else {
                col.width = col.maxWidth || col.minWidth;
            }
    ...
    return dom_1.el(".dhx_grid.dhx_widget", {
        class: (renderConfig.css || "") + (!isSticky ? " dhx_grid_border" : ""),
        dhx_widget_id: uid
    }, [
...
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = __webpack_require__(10);
var InputEditor_1 = __webpack_require__(192);
var SelectEditor_1 = __webpack_require__(193);
var DateEditor_1 = __webpack_require__(194);
var CheckboxEditor_1 = __webpack_require__(195);
var ComboboxEditor_1 = __webpack_require__(196);
var lastEditor = {
    cell: {
        row: null,
        col: null
...
var view_1 = __webpack_require__(4);
var ts_data_1 = __webpack_require__(5);
var Editor_1 = __webpack_require__(82);
var KeyNavigation_1 = __webpack_require__(210);
...
var ts_layout_1 = __webpack_require__(14);
var ts_toolbar_1 = __webpack_require__(28);
var types_1 = __webpack_require__(213);
var WindowController_1 = __webpack_require__(214);
...
var Window = /** @class */ (function () {
    ...
    Window.prototype.show = function (left, top) {
        ...
        this.config.left = left = core_1.isDefined(left) ? left : (window.innerWidth - width) / (this.config.modal ? 2 : 2 + window.pageXOffset);
        this.config.top = top = core_1.isDefined(top) ? top : (window.innerHeight - height) / (this.config.modal ? 2 : 2 + window.pageYOffset);
        if (this._isActive) {
    ...
    Window.prototype._initUI = function () {
        ...
        rows.push({ id: "content", css: isHeader ? "dhx_window-content" : "dhx_window-content-without-header" });
...
var ts_grid_1 = __webpack_require__(52);
var core_1 = __webpack_require__(1);
var TreeGridCollection_1 = __webpack_require__(84);
var ts_data_1 = __webpack_require__(5);
var TreeGrid = /** @class */ (function (_super) {
    ...
    function TreeGrid(container, config) {
        ...
        if (!_this.config.dropBehaviour) {
            _this.config.dropBehaviour = ts_data_1.DropBehaviour.sibling;
        }
    ...
    TreeGrid.prototype._getTreeHeadersWidth = function () {
        if (this.config.columns[0].maxWidth || this.config.columns[0].minWidth || this.config.fitToContainer) {
            return;
        }
