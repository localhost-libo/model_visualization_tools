 ...
 */(function (e, t) {
    ...
    return t.augment(i, {
        _events: [], _eventMap: {}, _bubblesEvents: [], _bubbleTarget: null, _getCallbacks: function (e) {
    ...
    var t = e("bui/component/uibase"), n = e("bui/component/manage"), r = e("bui/component/view"),
        ...
        p = t.extend([t.Decorate, t.Tpl, t.ChildCfg, t.KeyNav, t.Depends], {
            isController: !0, getCssClassWithPrefix: n.getCssClassWithPrefix, initializer: function () {
                var e = this;
...
,
    ...
    }), i.ATTRS = ATTRS = BUI.merge(!0, n.ATTRS, {events: {value: {validchange: !0, change: !0}}}), BUI.augment(i, n, {
        __bindUI: function () {
    ...
    return i.ATTRS = {
        ...
        initializer: function (e) {
            ...
            var n = this, r = n.get("contentId"), i = $("#" + r).find("form"), s = n.get("editor"),
                o = t.merge(s, {contentId: r, form: {srcNode
        :
            i
        }
        })
